...
project = u'Apprendre à programmer (sans se faire chier)' # e.g. How To Think Like a Computer Scientist
copyright = u'Johann Dreo' # e.g. "2013, Brad Miller and David Ranum"
...
html_title = u'Apprendre à programmer (sans se faire chier)'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='AAPSSFC'
...
html_logo = "_images/aapssfc_logo.png"
